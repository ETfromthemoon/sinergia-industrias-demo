  ...
  return (
    <main>
      ...
      <PageHero
        ...
        subhead="Combinamos procesos, tecnología y cumplimiento con una forma de trabajo directa: entender bien, diseñar lo necesario y acompañar hasta que funcione."
