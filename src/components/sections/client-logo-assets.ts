export const CLIENT_LOGOS = {
  "Arriendo Legal": { src: "/client-logos/arriendo-legal.png", alt: "Arriendo Legal", inverse: true },
  ...
  Easy: { src: "/client-logos/easy.svg", alt: "Easy" },
  ...
  "MB Chemicals": { src: "/client-logos/mb-chemicals.png", alt: "MB Chemicals", inverse: true },
