          ...
          <div>
            {SERVICES.map((service, index) => (
              ...
              >
                <Link
                  href={service.href}
                  className="group grid gap-4 border-b border-steel-200 py-8 transition-colors hover:bg-steel-50/60 sm:grid-cols-[3rem_0.55fr_1fr_auto] sm:items-center sm:px-4 sm:py-9"
                >
                  ...
                  <span>
                    ...
                    <span className="mt-2 block font-display text-2xl text-foreground sm:text-3xl">
                      {service.shortTitle}
                    </span>
                  </span>
                  ...
                  <span className="grid size-10 place-items-center rounded-full border border-steel-200 text-navy transition-all group-hover:border-navy group-hover:bg-navy group-hover:text-white">
